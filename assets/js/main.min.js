...
function task_form_handler(e) {
	...
	return $.ajax({
		...
		} else $("#_task_modal").attr("data-task-created", !0), $("#_task_modal").modal("hide"), init_task_modal(e.id), location.reload(), reload_tasks_tables(), $("body").hasClass("kan-ban-body") && $("body").hasClass("tasks") && tasks_kanban()
	}).fail(function (e) {
