...
function validate_lead_profile_text_input(b,a){return $(".not-valid-"+a).remove(),$('[name="'+a+'"]').parent().removeClass("has-error"),!!(0==b.length||b.match(/^\d*[a-z][a-z\d\s]*$/i))||($('[name="'+a+'"]').parent().addClass("has-error"),$('[name="'+a+'"]').parent().append('<p class="text-danger not-valid-'+a+'" style="">Invalid data</p>'),!1)}function validate_lead_profile_no_space(b,a){return $(".not-valid-"+a).remove(),$('[name="'+a+'"]').parent().removeClass("has-error"),0==b.length||b.length===b.trim().length||($('[name="'+a+'"]').parent().addClass("has-error"),$('[name="'+a+'"]').parent().append('<p class="text-danger not-valid-'+a+'" style="">Invalid data</p>'),!1)}function validate_lead_profile_form(){var a=!0;return $('input[name="name"]').each(function(b){!1==validate_lead_profile_text_input($(this).val(),"name")&&(a=!1)}),$('input[name="title"]').each(function(b){!1==validate_lead_profile_text_input($(this).val(),"title")&&(a=!1)}),$('input[name="website"]').each(function(b){!1==validate_lead_profile_text_input($(this).val(),"website")&&(a=!1)}),$('input[name="phonenumber"]').each(function(b){!1==validate_lead_profile_no_space($(this).val(),"phonenumber")&&(a=!1)}),$('input[name="company"]').each(function(b){!1==validate_lead_profile_text_input($(this).val(),"company")&&(a=!1)}),$('input[name="address"]').each(function(b){!1==validate_lead_profile_text_input($(this).val(),"address")&&(a=!1)}),$('input[name="city"]').each(function(b){!1==validate_lead_profile_text_input($(this).val(),"city")&&(a=!1)}),$('input[name="state"]').each(function(b){!1==validate_lead_profile_text_input($(this).val(),"state")&&(a=!1)}),$('input[name="zip"]').each(function(b){!1==validate_lead_profile_no_space($(this).val(),"zip")&&(a=!1)}),a}
...
function task_form_handler(a){tinymce.triggerSave(),$("#_task_modal").find('input[name="startdate"]').prop("disabled",!1),$("#_task_modal").find('button[type="submit"]').prop("disabled",!0),$("#_task_modal input[type=file]").each(function(){""===$(this).val()&&$(this).prop("disabled",!0)});var b=a.action,c=new FormData($(a)[0]);return $.ajax({type:$(a).attr("method"),data:c,mimeType:$(a).attr("enctype"),contentType:!1,cache:!1,processData:!1,url:b}).done(function(a){if((!0===(a=JSON.parse(a)).success||"true"==a.success)&&alert_float("success",a.message),$("body").hasClass("project")){var c=window.location.href,b=[];c=c.split("?");var d=get_url_param("group"),e=get_url_param("exclude_completed");d&&(b.group=d),e&&(b.exclude_completed=e),b.taskid=a.id,window.location.href=buildUrl(c[0],b)}else $("#_task_modal").attr("data-task-created",!0),$("#_task_modal").modal("hide"),reload_tasks_tables(),$("body").hasClass("kan-ban-body")&&$("body").hasClass("tasks")&&tasks_kanban()}).fail(function(a){alert_float("danger",JSON.parse(a.responseText))}),!1}
