...
function dt_custom_view(e, t, a, i) {
	...
	if(cur_val == '' || cur_val == 'task_status_1' || cur_val == 'task_status_2' || cur_val == 'task_status_3' || cur_val == 'task_status_4' || cur_val == 'task_status_5'){
	...
	$.ajax({
		type: "POST",
		url: url,
		data: {task_type:task_type,task_assign:task_assign,cur_val:cur_val,period_from:period_from,period_to:period_to,task_project:task_project},
