...
class Deals_merge_fields extends App_merge_fields
{
    ...
    public function format($project_id, $additional_data = [])
    {
        ...
        $fields['{deal_name}']           = '';
        $fields['{deal_deadline}']       = '';
        $fields['{deal_start_date}']     = '';
        ...
        $fields['{deal_name}']        = $project->name;
        $fields['{deal_deadline}']    = _d($project->deadline);
        $fields['{deal_start_date}']  = _d($project->start_date);
        $fields['{deal_description}'] = $project->description;
        ...
        if (isset($additional_data['customer_template'])) {
            $fields['{deal_link}'] = site_url('clients/project/' . $project_id);
            ...
            $fields['{deal_link}'] = admin_url('projects/view/' . $project_id);
