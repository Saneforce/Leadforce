...
class App_tabs
{
    ...
    public function add_product_profile_tab($slug, $tab)
    {
        $this->add($slug, $tab, 'product_profile');

        return $this;
    }

    public function get_product_profile_tabs()
    {
        return $this->get('product_profile');
    }
