                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6">
						...
						foreach($teamleaders as $teamleader){
							if($mail->teamleader == $teamleader['staffid']){
								$teamleaderselected = $teamleader['staffid'];
							}
						}
						echo render_select('teamleader',$teamleaders,array('staffid',array('firstname','lastname')),'teamleader',$teamleaderselected,array('data-ays-ignore'=>true));
						...
						echo render_select('responsible',$members,array('staffid',array('firstname','lastname')),'leads_email_integration_default_assigned',$selected,array('data-ays-ignore'=>true)); ?>
                        <hr />
