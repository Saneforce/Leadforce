...
<div class="clearfix"></div> 
<div style="position: absolute;z-index: 999;left: 30%;display:none" id="all_div">
<button type="button" data-toggle="modal"   data-target="#send_file_all" class="btn btn-info btn-icon" ><i class="fa fa-envelope" ></i></button>
</div>
<table class="table dt-table scroll-responsive table-project-files" data-order-col="7" data-order-type="desc">
  <thead>
    <tr>
      <th data-orderable="false"><span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="project-files" onclick="check_all(this)"><label></label></div></th>
  ...
  <tbody>
    <?php foreach($files as $file){
      ...
      <tr>
        <td>
          <div class="checkbox"><input type="checkbox" value="<?php echo $file['id']; ?>" class="check_mail" onclick="check_header(this)"><label></label></div>
        </td>
   ...
   <div class="modal fade" id="send_file_all" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <?php echo form_open('/admin/misc/send_file_all/'.$project->id ); ?>
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
