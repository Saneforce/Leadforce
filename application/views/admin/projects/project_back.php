            ...
            <div class="col-md-7">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        ?>
                        <?php $value = (isset($project) ? $project->name : 'Deal '); ?>
                        <?php echo render_input('name','project_name',$value,'',array('maxlength'=>191)); ?>
                ...
                <?php //} ?>
                    ...
                    ?>
                        ...
                        <div class="col-md-6">
                          ...
                          -->
                            <div class="col-md-6 form_teamleader">
                                <?php 
...
?>
                        ...
                        if(isset($project)) {
                            if(in_array(get_staff_user_id(),$ownerHierarchy) || $project->teamleader == get_staff_user_id() || is_admin(get_staff_user_id()))
                                echo render_select('project_members[]',$staff,array('staffid',array('firstname','lastname')),'project_members',$selected,array('multiple'=>true,'class'=>'formassigned','data-actions-box'=>true),array(),'','',false);
                            else
                                echo render_select('project_members[]',$staff,array('staffid',array('firstname','lastname')),'project_members',$selected,array('multiple'=>true,'class'=>'formassigned','data-actions-box'=>true,'disabled'=>true),array(),'','',false);
                        } else {
                            echo render_select('project_members[]',$staff,array('staffid',array('firstname','lastname')),'project_members',$selected,array('multiple'=>true,'class'=>'formassigned','data-actions-box'=>true),array(),'','',false);
                        }
                      ...
                      -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <?php echo render_date_input('start_date','project_start_date',$start_date,array('data-date-end-date'=>$deadline,'readonly'=>'readonly')); ?>
                            </div>
                            <div class="col-md-6">
                                <?php echo render_date_input('deadline','project_deadline',$deadline,array('data-date-min-date'=>$start_date,'readonly'=>'readonly')); ?>
                            </div>
                        </div>
