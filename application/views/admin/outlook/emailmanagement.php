									...
									<div class="col-md-12 bg-white" style="border-radius:6px;">
										...
										<div class="col-md-9">
											<fieldset id="tab011" class="show">
												<form action="<?php echo admin_url('outlook_mail/send'); ?>" method="post" id="compose_email" enctype='multipart/form-data' onsubmit="over_lay('compose')">
						...
						<div class="modal-wrapper">
							...
							<div id="overlay_new" class="overlay_new" style="display:none"><div class="spinner"></div></div>
								<div class="modal-content">
									...
									<form action="<?php echo admin_url('outlook_mail/forward'); ?>" method="post"  enctype='multipart/form-data'  onsubmit="over_lay('forward')">
										<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
										<div class="modal-body">
											<div class="form-group">
											...
											<div class="form-group">
												...
												<input name="msg_id" type="hidden" id ="forward_msg_id">
											</div>
						...
						<div class="modal-wrapper">
							<div class="modal-dialog">
								...
								<div class="modal-content">
									...
									<form action="<?php echo admin_url('outlook_mail/reply'); ?>" method="post"  enctype='multipart/form-data'  onsubmit="over_lay('new1')">
										<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
										<div class="modal-body">
											<div class="form-group">
												...
												<input name="msg_id" type="hidden" id="reply_msg_id"  >
											</div>
											<div class="form-group">
...
function add_content(msg_id){
	...
	function(data,status){
		...
		$('#f_getFile').val('');
		$('#forward_subject').val(json.subject);
...
$('#del_mail').click(function() {
	...
	var BASE_URL = "<?php echo base_url();?>";
    $.ajax({
        url: BASE_URL+'admin/outlook_mail/delete_outlook_message',
        type: 'POST',
        data: form.serialize(),
        success: function(data) {
			var results = JSON.parse(data);
...
$('#unread_mail').click(function(){
	...
	var BASE_URL = "<?php echo base_url();?>";
    $.ajax({
        url: BASE_URL+'admin/outlook_mail/update_message/false',
        type: 'POST',
        data: form.serialize(),
        success: function(data) {
...
$('#read_mail').click(function(){
	...
	var BASE_URL = "<?php echo base_url();?>";
    $.ajax({
        url: BASE_URL+'admin/outlook_mail/update_message/true',
        type: 'POST',
        data: form.serialize(),
        success: function(data) {
			var pag_no = $('#req_page').val();
