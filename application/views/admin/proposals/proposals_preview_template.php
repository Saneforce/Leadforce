         ...
         <div class="horizontal-tabs">
            <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
               ...
               <li role="presentation">
                  ...
                  <?php //echo _l('proposal_comments'); ?> Client Discussions
                  </a>
               </li>
               <!-- <li role="presentation">
               ...
               <li role="presentation" class="tab-separator">
                 ...
                 <li role="presentation" class="tab-separator">
                     ...
                     <?php //echo _l('estimate_notes'); ?> Internal Discussions
...
//pre($items);
                                  ...
                                  $itemLists = $proposal->items;
                                    ...
                                    ?>
                                    <!-- <div class="col-md-9 text-right" style="padding-top:30px">
                                      <span id="stxt"><p>Subtotal <?php echo $discount; ?></p></span>
                                      <span id="suptotaltxt"><?php echo $tax_txt; ?></span>
                                      <b>Total</b>
                                    </div>
                                    <div class="col-md-2 text-right" style="padding-top:30px">
                                      <span id="stotal"><p><?php echo number_format($subtotal,2); ?></p></span>
                                      <span id="suptotal"><?php echo $tax_val; ?></span>
                                      <b><span id="grandtotal"><?php echo number_format($proj_cost,2); ?></span></b>
                                    </div> -->
                          <div class="row mtop15">
                              <table class="table text-right">
                                  <tbody>
                                    <tr id="subtotal">
                                        <td><span class="bold"><?php echo _l('estimate_subtotal').' '.$discount; ?></span>
                                        </td>
                                        <td class="subtotal">
                                          <?php echo app_format_money($subtotal, $proposal->currency_name); ?>
                                        </td>
                                    </tr>
                                    <?php if($tax_val) { ?>
                                    <tr>
                        ...
                        <div class="row mtop25">
                           <div class="col-md-6 col-md-offset-6 text-right">
                              ...
                              <div class="pull-right">
                                ...
                                ?>
                                 <img src="<?php echo site_url('download/preview_image?path='.protected_file_url_by_path(get_upload_path_by_type('proposal').$proposal->id.$dbname[0].'/'.$proposal->signature)); ?>" class="img-responsive" alt="">
                              </div>
                           </div>
                        </div>
                        <?php } ?>
               ...
               <div role="tabpanel" class="tab-pane" id="tab_tasks">
                  <?php init_relation_tasks_table1(array( 'data-new-rel-id'=>$proposal->id,'data-new-rel-type'=>'proposal')); ?>
               </div>
