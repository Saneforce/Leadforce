   ...
   <div class="row">
      <div class="col-md-8 task-single-col-left">
         ...
         <p class="no-margin pull-left" style="<?php echo 'margin-'.(is_rtl() ? 'left' : 'right').':5px !important'; ?>">
            <a href="#" class="btn btn-default pull-left mright5 btnunmark" id="task-single-mark-complete-btn" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>" onclick="mark_complete(<?php echo $task->id; ?>); return false;" data-toggle="tooltip" title="<?php echo _l('task_single_mark_as_complete'); ?>">
            &nbsp;
            </a>
         </p>
         ...
         <p class="no-margin pull-left" style="<?php echo 'margin-'.(is_rtl() ? 'left' : 'right').':5px !important'; ?>">
            <a href="#" class="btn btn-info  pull-left mright5 btnmark" id="task-single-unmark-complete-btn" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>" onclick="unmark_complete(<?php echo $task->id; ?>); return false;" data-toggle="tooltip" title="<?php echo _l('task_unmark_as_complete'); ?>">
      ...
      <div class="col-md-4 task-single-col-right">
		 ...
		 <h5 class="no-mtop task-info-created">
			<?php 
			$CI =& get_instance();
			$tasktypedetails = $CI->tasktype_model->getTasktype($task->tasktype); ?>
			<small class="text-dark"><?php echo _l('tasktype').' : '.$tasktypedetails->name.'</span>'; ?>
         </h5>
         <h5 class="no-mtop task-info-created">
               ...
               <span class="task-single-menu task-menu-status">
                  ...
                  <span class="content-menu hide">
                     <ul>
                        ...
                        $datas = 1;
                        if(_d($task->startdate) == Date('Y-m-d')){
                             $datas = 3;
                        }
                        if(_d($task->startdate) < Date('Y-m-d')){
                             $datas = 2;
                        ...
                        ?>
                           <li>
                              <a href="#" onclick="task_mark_as(<?php echo $datas; ?>,<?php echo $task->id; ?>); return false;">
                              <?php echo _l('task_mark_as',_l('task_status_'.$datas)); ?>
                              </a>
                           </li>
                           <?php
                        ...
                        <li>
                           <a href="#" onclick="task_mark_as(5,<?php echo $task->id; ?>); return false;">
                           <?php echo _l('task_mark_as',_l('task_status_5')); ?>
                           </a>
                        </li>
                        <?php }
         ...
         <div class="task-info task-single-inline-wrap task-info-start-date">
            <h5><i class="fa task-info-icon pull-left fa-margin"></i>
               <?php echo _l('project_customer'); ?>:
               <?php echo (isset($project_details_company) ? $project_details_company : ''); ?>
            </h5>
         </div>
         <div class="task-info task-single-inline-wrap task-info-start-date">
            <h5><i class="fa task-info-icon pull-left fa-margin"></i>
               <?php echo _l('project_contacts'); ?>:
               <?php echo (isset($project_contacts_text) ? $project_contacts_text : ''); ?>
            </h5>
         </div>
         <!--  
         ...
         */ ?>
         ...
         <?php if(count($task->assignees_ids) == 0){ ?>
