...
foreach ($rResult as $aRow) {
    ...
    for ($i = 0; $i < count($aColumns); $i++) {
		...
		$_data1 = '<a href="'.admin_url('reports/edit_deal_report/'.$aRow[db_prefix().'shared.report_id'].'/'.$aRow[db_prefix().'shared.id']).'"> <i class="fa fa-area-chart" style="font-size:15px"></i>   '.$aRow[db_prefix().'report.report_name'].'</a>';
