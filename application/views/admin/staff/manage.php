			...
			<div class="col-md-12">
				...
				<div class="panel_s">
					<div class="panel-body">
						...
						<div class="_buttons">
							<a href="<?php echo admin_url('staff'); ?>" class="btn btn-info pull-left mleft5"><?php echo _l('staff'); ?></a>
						...
						<?php } ?>
						<div class="clearfix"></div>
						<div style="clear:both; margin-bottom:45px;"><a href="<?php echo admin_url('staff/member'); ?>" class="btn btn-info pull-left display-block"><?php echo _l('new_staff'); ?></a></div>
						<?php
						$table_data = array(
							_l('staff_dt_name'),
							_l('role'),
							_l('designation'),
							_l('staff_add_edit_reporting_to'),
							_l('staff_add_edit_emp_id'),
							_l('staff_add_edit_email'),
							_l('staff_add_edit_action_for'),
							);
