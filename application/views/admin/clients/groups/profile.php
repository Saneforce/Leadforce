...
<?php if($client->deleted_status == 1) { ?>
    <a href="<?php echo admin_url('clients/restore_client/'.$client->userid); ?>" style="float:right; margin-top:-6px;" class="btn btn-info"><?php echo _l('restore'); ?></a>
<?php } ?>
</h4>
...
<div class="row">
   ...
   <div class="col-md-12">
      ...
      <div class="tab-content">
         ...
         <?php if($customer_custom_fields && 0) { ?>
         ...
         <div role="tabpanel" class="tab-pane<?php if(!$this->input->get('tab')){echo ' active';}; ?>" id="contact_info">
            ...
            <!-- 
               <div class="col-md-12 mtop15 <?php if(isset($client) && (!is_empty_customer_company($client->userid) && total_rows(db_prefix().'contacts',array('userid'=>$client->userid,'is_primary'=>1)) > 0)) { echo ''; } else {echo ' hide';} ?>" id="client-show-primary-contact-wrapper">
                ...
                -->
                <input type="hidden" id="client_id" value="<?php echo $client->userid; ?>" >
               <div class="col-md-6">
                  ...
                  <?php }
                     ...
                     */ ?>
                  <?php if(get_option('disable_language') == 0 && 0){ ?>
