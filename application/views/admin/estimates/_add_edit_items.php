...
<div class="panel-body mtop10">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-5">
                        <div class="input-group" id="discount-total">
                           ...
                           <input type="number" value="<?php echo (isset($estimate) ? $estimate->discount_percent : 0); ?>" class="form-control pull-left input-discount-percent<?php if (isset($estimate) && !is_sale_discount($estimate, 'percent') && is_sale_discount_applied($estimate)) {
                                                                                                                                                                                  echo ' hide';
                                                                                                                                                                                } ?>" min="0" max="100" name="discount_percent">

                           <input type="number" data-toggle="tooltip" data-title="<?php echo _l('numbers_not_formatted_while_editing'); ?>" value="<?php echo (isset($estimate) ? $estimate->discount_total : 0); ?>" class="form-control pull-left input-discount-fixed<?php if (!isset($estimate) || (isset($estimate) && !is_sale_discount($estimate, 'fixed'))) {
                                                                                                                                                                                                                                                                          echo ' hide';
            ...
            <tr>
               <td>
                  <div class="row">
                     ...
                     <div class="col-md-5">
                        <input type="number" data-toggle="tooltip" data-title="<?php echo _l('numbers_not_formatted_while_editing'); ?>" value="<?php if (isset($estimate)) {
  ...
  <div class="col-md-12 row" style="padding-bottom:13px;">
    ...
    <input type="hidden" id="prject_id" name="project_id" value="<?php echo $proposal->id; ?>">
  ...
  <div  class="css-table">
    ...
    <div class="css-table-row" id="particularsrowfooter">
      <div class="text-right">
        <span id="stxt"><p>Subtotal <?php echo $discount; ?></p>
        </span><span id="suptotaltxt"><?php echo $tax_txt; ?></span><b>Total</b>
      </div>
      <div class="text-right">
        <span id="stotal"><p><?php echo number_format($subtotal, 2); ?></p>
