            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12"><h4 class="no-margin"><?php echo _l('email_templates'); ?></h4></div>
                            ...
                            <div class="col-md-12">
                                <!-- <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <a class="pull-right btn btn-primary" href="<?php echo admin_url('emails/add_email_template/invoice'); ?>">Add Template</a>
                                    </div>
                                </div> -->
                                 <!-- <hr class="hr-panel-heading" /> -->
                                <h4 class="bold well email-template-heading">
                                    ...
                                    <?php echo _l('email_template_invoices_fields_heading'); ?>
                                      <?php if($hasPermissionEdit){ ?>
                                      <a href="<?php echo admin_url('emails/add_email_template/invoice'); ?>" class="pull-right mleft5 mright15 btn btn-primary addtemp">+ Add</a> <span class="pull-right mleft5"> | </span> 
                                      <a href="<?php echo admin_url('emails/disable_by_type/invoice'); ?>" class="pull-right mleft5"><small><?php echo _l('disable_all'); ?></small></a> <span class="pull-right mleft5"> | </span>
                            ...
                            <div class="col-md-12">
                                <!-- <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <a class="pull-right btn btn-primary" href="<?php echo admin_url('emails/add_email_template/proposals'); ?>">Add Template</a>
                                    </div>
                                </div> -->
                                <!-- <hr class="hr-panel-heading" /> -->
                                <h4 class="bold well email-template-heading">
                                    <?php echo _l('email_template_proposals_fields_heading'); ?>
                                     <?php if($hasPermissionEdit){ ?>
                                      <!-- <a href="<?php echo admin_url('emails/disable_by_type/proposals'); ?>" class="pull-right mleft5 mright25"><small><?php echo _l('disable_all'); ?></small></a><span class="pull-right mleft5"> | </span>
                                      <a href="<?php echo admin_url('emails/enable_by_type/proposals'); ?>" class="pull-right"><small><?php echo _l('enable_all'); ?></small></a>
                                      -->
                                      <a href="<?php echo admin_url('emails/add_email_template/proposals'); ?>" class="pull-right mleft5 mright15 btn btn-primary addtemp">+ Add</a> <span class="pull-right mleft5"> | </span> 
                                      <a href="<?php echo admin_url('emails/disable_by_type/proposals'); ?>" class="pull-right mleft5"><small><?php echo _l('disable_all'); ?></small></a> <span class="pull-right mleft5"> | </span>
                                      <a href="<?php echo admin_url('emails/enable_by_type/proposals'); ?>" class="pull-right"><small><?php echo _l('enable_all'); ?></small></a>
                                     <?php } ?>
							...
							<?php hooks()->do_action('before_reminder_email_templates'); ?>
                            <div class="col-md-12">
                                <!-- <div class="row">
                                    <div class="col-md-10">
                                        <h4 class="no-margin"><?php echo _l('email_templates'); ?></h4>
                                ...
                                <!-- <hr class="hr-panel-heading" /> -->
                                <h4 class="bold well email-template-heading">
                                    <?php echo _l('email_template_reminder_fields_heading'); ?>
                                     <?php /*if($hasPermissionEdit){ ?>
                                      <!-- <a href="<?php echo admin_url('emails/disable_by_type/proposals'); ?>" class="pull-right mleft5 mright25"><small><?php echo _l('disable_all'); ?></small></a><span class="pull-right mleft5"> | </span>
                                      <a href="<?php echo admin_url('emails/enable_by_type/proposals'); ?>" class="pull-right"><small><?php echo _l('enable_all'); ?></small></a>
                                      -->
                                    <?php /*  <a href="<?php echo admin_url('emails/add_email_template/reminder'); ?>" class="pull-right mleft5 mright15 btn btn-primary addtemp">+ Add</a> <span class="pull-right mleft5"> | </span> *//*?>
                                      <a href="<?php echo admin_url('emails/disable_by_type/reminder'); ?>" class="pull-right mleft5"><small><?php echo _l('disable_all'); ?></small></a> <span class="pull-right mleft5"> | </span>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php foreach($reminders as $reminder_template){ ?>
                                            <tr>
                                                <td class="<?php if($reminder_template['active'] == 0){echo 'text-throught';} ?>">
                                                    <a href="<?php echo admin_url('emails/email_template/'.$reminder_template['emailtemplateid']); ?>"><?php echo $reminder_template['name']; ?></a>
                                                    <?php if(ENVIRONMENT !== 'production'){ ?>
                                                    <br/><small><?php echo $reminder_template['slug']; ?></small>
                                                    <?php } ?>
                                                    <?php /*if($hasPermissionEdit){ ?>
                                                    <a href="<?php echo admin_url('emails/'.($reminder_template['active'] == '1' ? 'disable/' : 'enable/').$reminder_template['emailtemplateid']); ?>" class="pull-right"><small><?php echo _l($reminder_template['active'] == 1 ? 'disable' : 'enable'); ?></small></a>
                                                    <?php }*/ ?>
                                                </td>
                                            </tr>
                                            <?php } ?>
											<?php foreach($proposal_reminders as $reminder_template){ ?>
                                            <tr>
                                                <td class="<?php if($reminder_template['active'] == 0){echo 'text-throught';} ?>">
                                                    <a href="<?php echo admin_url('emails/email_template/'.$reminder_template['emailtemplateid']); ?>"><?php echo $reminder_template['name']; ?></a>
                                                    <?php if(ENVIRONMENT !== 'production'){ ?>
                                            ...
                                            <?php } ?>
											<?php foreach($target_reminders as $reminder_template){ ?>
                                            <tr>
                                                <td class="<?php if($reminder_template['active'] == 0){echo 'text-throught';} ?>">
                                                    <a href="<?php echo admin_url('emails/email_template/'.$reminder_template['emailtemplateid']); ?>"><?php echo $reminder_template['name']; ?></a>
                                                    <?php if(ENVIRONMENT !== 'production'){ ?>
							...
							<?php hooks()->do_action('before_show_alert_templates'); ?>
                            <div class="col-md-12">
                               
                                <!-- <hr class="hr-panel-heading" /> -->
                                <h4 class="bold well email-template-heading">
                                    <?php echo _l('show_alert'); ?>
                                     <?php /*if($hasPermissionEdit){ ?>
                                     
                                      <a href="<?php echo admin_url('emails/disable_by_type/show_alert'); ?>" class="pull-right mleft5"><small><?php echo _l('disable_all'); ?></small></a> <span class="pull-right mleft5"> | </span>
                                      <a href="<?php echo admin_url('emails/enable_by_type/show_alert'); ?>" class="pull-right"><small><?php echo _l('enable_all'); ?></small></a>
                                     <?php }*/ ?>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php foreach($activity_show_alerts as $show_alert_template){ ?>
                                            <tr>
                                                <td class="<?php if($show_alert_template['active'] == 0){echo 'text-throught';} ?>">
                                                    <a href="<?php echo admin_url('emails/email_template/'.$show_alert_template['emailtemplateid']); ?>"><?php echo $show_alert_template['name']; ?></a>
                                                    <?php if(ENVIRONMENT !== 'production'){ ?>
                                                    <br/><small><?php echo $show_alert_template['slug']; ?></small>
                                                    <?php } ?>
                                                    <?php /*if($hasPermissionEdit){ ?>
                                                    <a href="<?php echo admin_url('emails/'.($show_alert_template['active'] == '1' ? 'disable/' : 'enable/').$show_alert_template['emailtemplateid']); ?>" class="pull-right"><small><?php echo _l($show_alert_template['active'] == 1 ? 'disable' : 'enable'); ?></small></a>
                                                    <?php }*/ ?>
                                                </td>
                                            </tr>
                                            <?php } ?>
											<?php foreach($proposal_show_alerts as $show_alert_template){ ?>
                                            <tr>
                                                <td class="<?php if($show_alert_template['active'] == 0){echo 'text-throught';} ?>">
                                                    <a href="<?php echo admin_url('emails/email_template/'.$show_alert_template['emailtemplateid']); ?>"><?php echo $show_alert_template['name']; ?></a>
                                                    <?php if(ENVIRONMENT !== 'production'){ ?>
                                            ...
                                            <?php } ?>
											<?php foreach($target_show_alerts as $show_alert_template){ ?>
                                            <tr>
                                                <td class="<?php if($show_alert_template['active'] == 0){echo 'text-throught';} ?>">
                                                    <a href="<?php echo admin_url('emails/email_template/'.$show_alert_template['emailtemplateid']); ?>"><?php echo $show_alert_template['name']; ?></a>
                                                    <?php if(ENVIRONMENT !== 'production'){ ?>
