         ...
         <div class="col-md-6">
            <div class="panel_s">
               <div class="panel-body">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <input type="hidden" name="id" value="<?php echo $template->emailtemplateid; ?>">
                        <input type="hidden" name="type" value="<?php echo $template->type; ?>">
                        <input type="hidden" name="slug" value="<?php echo $template->slug; ?>">
                        <?php echo render_input('name','template_name',$template->name,'text',array('required'=>'')); ?>
