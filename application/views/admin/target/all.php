...
$( "#add_deal" ).validate({
  rules: {
    ...
    initDataTable('.table-target-deal', admin_url+'target/deal_table', notSortableAndSearchableItemColumns, notSortableAndSearchableItemColumns,'undefined',[1,'asc']);
...
$("#pipeline_stage_1").change(function(){
...
$('#start_date1').datepicker({
   ...
   /* $("#start_date1").datepicker({
      ...
      //  $('#end_date1').datetimepicker('setStartDate', minDate);
    });
