...
<div role="tabpanel" class="tab-pane" id="company_info">
    ...
    <label for="default_currency" class="control-label"><?php echo _l('base_currency_string'); ?></label>
    <select name="settings[default_currency]" class="selectpicker" id="default_currency" data-width="100%"
            data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
            <?php foreach(get_all_currency() as $curr) { ?>
            <option value="<?php echo $curr['id']; ?>"
                <?php if('1' == $curr['isdefault']){echo ' selected';} ?>>
