            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php  if(count($contact->alternative_emails) > 0){
                        ...
                        <?php  if(count($contact->alternative_phonenumber) > 0){
                    ...
                    <div class="form-group" app-field-wrapper="deals[]">
                        <div class="input-group" style="width: 100%;">
                            ...
                            <div class="dropdown bootstrap-select input-group-select show-tick bs3 bs3-has-addon" style="width: 100%;">
                                ...
                                <div class="input-group-addon" style="opacity: 1;width: 34px;float: right;height: 36px;padding-top: 11px;"><a href="#" data-toggle="modal" data-target="#projectid_add_modal"><i class="fa fa-plus"></i></a></div>
                            </div>
