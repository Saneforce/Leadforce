...
<div class="row">
 ...
 <div class="usernote hide">
    <?php echo form_open(admin_url( 'misc/add_productnote/'.$product->id)); ?>
    <?php echo render_textarea( 'notes', 'note_description', '',array( 'rows'=>5)); ?>
    ...
    <table class="table dt-table scroll-responsive" data-order-col="2" data-order-type="desc">
            ...
            <tr>
                <td width="50%">
                  <div data-note-description="<?php echo $note['id']; ?>">
                    <?php echo check_for_links($note['notes']); ?>
                </div>
                <div data-note-edit-textarea="<?php echo $note['id']; ?>" class="hide">
                    <textarea name="notes" class="form-control" rows="4"><?php echo clear_textarea_breaks($note['notes']); ?></textarea>
                    <div class="text-right mtop15">
                      ...
                      <button type="button" class="btn btn-info" onclick="edit_prodnote(<?php echo $note['id']; ?>);"><?php echo _l('update_note'); ?></button>
                  </div>
              </div>
          </td>
          <td>
        ...
        <td data-order="<?php echo $note['dateadded']; ?>">
         <?php if(!empty($note['date_contacted'])){ ?>
          ...
          <?php } ?>
          <?php echo _dt($note[ 'created_date']); ?>
        </td>
        <td>
            ...
            <a href="<?php echo admin_url('misc/delete_productnote/'. $note['id']); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
            <?php } ?>
        </td>
    </tr>
    <?php } ?>
