                    ...
                    <div class="panel-body">
                        ...
                        <div class="customers_field_info mbot25 alert alert-info<?php if(isset($custom_field) && $custom_field->fieldto != 'customers' || !isset($custom_field)){echo ' hide';} ?>">
                          ...
                          <div class="select-placeholder form-group">
							...
							<?php $attrs = array('onblur'=>"check_name(this.value,'name')",'onkeyup'=>"check_validate()", 'maxlength'=>"150"); ?>
                            <?php echo render_input('name','custom_field_name',$value,'text',$attrs); ?>
                           ...
                           <div class="select-placeholder form-group">
                            ...
                            <?php /*<div class="checkbox checkbox-primary">
                             ...
                             */?>
                             <?php /*<div class="checkbox checkbox-primary disalow_client_to_edit <?php if(!isset($custom_field) || (isset($custom_field) && !in_array($custom_field->fieldto,$client_portal_fields)) || (isset($custom_field) && !in_array($custom_field->fieldto,$client_editable_fields))){echo 'hide';} ?>">
                            ...
                            <div class="checkbox checkbox-primary" id="required_wrap">
                                ...
                                <label for="required"><?php echo _l('Is Mandatory'); ?></label>
                            </div>
                            <?php /* <p class="bold"><?php echo _l('custom_field_visibility'); ?></p> */?>
                            <div class="checkbox checkbox-primary" style=" display:none">
                                ...
                                <input type="checkbox" name="show_on_table" id="show_on_table" checked>
