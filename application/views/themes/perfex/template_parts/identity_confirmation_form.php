  ...
  <div class="modal-body">
    ...
    <div id="identity_fields">
     <div class="form-group">
      ...
      <div class="col-sm-10">
       <input type="text" name="acceptance_firstname" id="acceptance_firstname" class="form-control" required="true" value="<?php echo (isset($contact) ? $contact->firstname : '') ?>" onblur="check_name(this.value,'acceptance_firstname')" >
     </div>
   </div>
   <div class="form-group">
    ...
    <div class="col-sm-10">
     <input type="text" name="acceptance_lastname" id="acceptance_lastname" class="form-control" required="true" value="<?php echo (isset($contact) ? $contact->lastname : '') ?>" onblur="check_name(this.value,'acceptance_lastname')" >
   </div>
 </div>
 <div class="form-group">
...
<div class="modal-footer">
 ...
 <hr />
 <button type="button" class="btn btn-default" data-dismiss="modal" onclick="check_reset()"><?php echo _l('cancel'); ?></button>
...
function check_reset(){
	 $("#identityConfirmationForm")[0].reset();
  ...
  $(function(){
   ...
   function check_name(a,ch_id){
	...
	$(function () {
        $("#acceptance_firstname").keypress(function (e) {
		...
		$("#acceptance_lastname").keypress(function (e) {
            var keyCode = e.keyCode || e.which;
            //Regex for Valid Characters i.e. Alphabets and Numbers.
            var regex = /^[A-Za-z0-9]+$/;
            //Validate TextBox value against the Regex.
