            ...
            <div class="tab-content">
               ...
               <div role="tabpanel" class="tab-pane<?php if($this->input->get('tab') === 'discussion'){echo ' active';} ?>" id="discussion">
                  ...
                  <div class="proposal-comment">
                     ...
                     <button type="submit" class="btn btn-info mtop10 pull-right" data-loading-text="<?php echo _l('wait_text'); ?>" id="save_cmt"><?php echo _l('proposal_add_comment'); ?></button>
                  ...
                  <?php
                     ...
                     foreach ($comments as $comment) {
                      ...
                      if($comment['staffid'] != 0){
                        ...
                        $proposal_comments .= $comment['orgName'];
                      }
                      $proposal_comments .= '</b>';
...
$(document).ready(function() {
  $('#save_cmt').on('click', function() {
    var $this = $(this);
    var loadingText = "<?php echo _l('wait_text'); ?>";
