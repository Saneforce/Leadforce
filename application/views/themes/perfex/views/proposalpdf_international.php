...
function get_content_from_proposal($name,$proposal)
{
    $default_content =array(
        'content1'=>'<span style="font-weight:bold">Dear Sir</span>,<br>Greetings from <span style="font-weight:bold">Kataria Group!</span><br>We have pleasure to quote hereunder our rates alongwith other terms & conditions for supply of LRPC Strands <span style="font-weight:bold">as per ASTM A416.</span>',
        'content2'=>'We are sure you will find our offer most competitive and looking forward to receive your valued orders accordingly.',
        'content3'=>'We assure you our Quality Product and Best Services.',
        ...
        'technical_standards'=>'Manufacturer Test Certificates (MTCs) will be provided.',
        'packing'=>'Reel – Less Coils 2.50MT to 3.00MT – in standard Sea Worthy Packing',
        'inspection'=>'Will be carried out at the Manufacturing Facility (Located at Ratlam MP - INDIA) at In-House Testing Laboratory. 3rd Party Inspection if required can be carried out before dispatch from the Plant (at buyer’s cost).',
    );
...
if(isset($proposal->items) && $proposal->items){
    ...
    $background_color ='background-color:#dbe5f1;';
    foreach($proposal->items as $count => $item){
        $table .='<tr style="">
        <td width="25%" style="border: 1px solid black;border-collapse: collapse;padding:10px;'.$background_color.'"><span style="font-weight:bold;">Item</span></td>
        <td width="75%" style="border: 1px solid black;border-collapse: collapse;padding:10px;'.$background_color.'"><span style="font-weight:bold;">'.getItemName($item['productid']).'</span></td>
        </tr>
        <tr>
        <td style="border: 1px solid black;border-collapse: collapse;"><span style="font-weight:bold">Quantity</span></td>
        <td style="border: 1px solid black;border-collapse: collapse;"><span style="font-weight:bold">'.$item['qty'].' /MT</span></td>
        </tr>
        <tr>
    ...
    $table .='
        <tr>
        <td style="border: 1px solid black;border-collapse: collapse;'.$background_color.'"><span style="font-weight:bold">Freight Charges</span></td>
        <td style="border: 1px solid black;border-collapse: collapse;'.$background_color.'" '.content_editable('freight_charge',$contentEditable).'>'.get_content_from_proposal('freight_charge',$proposal).'</td>
        </tr>
        <tr>
        <td style="border: 1px solid black;border-collapse: collapse;"><span style="font-weight:bold">Technical Standards</span></td>
        <td style="border: 1px solid black;border-collapse: collapse;" '.content_editable('technical_standards',$contentEditable).'>'.get_content_from_proposal('technical_standards',$proposal).'</td>
        </tr>
        <tr>
        <td style="border: 1px solid black;border-collapse: collapse;'.$background_color.'"><span style="font-weight:bold">Inspection</span></td>
        <td style="border: 1px solid black;border-collapse: collapse;'.$background_color.'" '.content_editable('inspection',$contentEditable).'>'.get_content_from_proposal('inspection',$proposal).'</td>
        </tr>
        <tr>
        <td style="border: 1px solid black;border-collapse: collapse;"><span style="font-weight:bold">Packing</span></td>
        <td style="border: 1px solid black;border-collapse: collapse;" '.content_editable('packing',$contentEditable).'>'.get_content_from_proposal('packing',$proposal).'</td>
        </tr>
        <tr>
        <td style="border: 1px solid black;border-collapse: collapse;'.$background_color.'"><span style="font-weight:bold">Despatch from Plant</span></td>
        <td style="border: 1px solid black;border-collapse: collapse;'.$background_color.'" '.content_editable('delivery_terms',$contentEditable).'>'.get_content_from_proposal('delivery_terms',$proposal).'</td>
        </tr>
        <tr>
        <td style="border: 1px solid black;border-collapse: collapse;"><span style="font-weight:bold">Payment Terms</span></td>
        ...
        <tr>
        <td style="border: 1px solid black;border-collapse: collapse;'.$background_color.'"><span style="font-weight:bold">Offer Validity</span></td>
        <td style="border: 1px solid black;border-collapse: collapse;'.$background_color.'">'.$abs_diff.' Days</td>
        </tr>';
    $table .='</table>';
}
