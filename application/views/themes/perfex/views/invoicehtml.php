   ...
   <div class="panel-body">
      <div class="col-md-10 col-md-offset-1">
         <div class="row mtop20">
            <div class="col-md-9 col-sm-6 transaction-html-info-col-left">
            ...
            <div class="col-sm-3 transaction-html-info-col-right">
         ...
         <div class="row">
            ...
            <?php } ?>
            <?php if(!empty($invoicepdf->tc)){ ?>
            <div class="col-md-12 invoice-html-terms-and-conditions">
               <hr />
               <b><?php echo _l('terms_and_conditions'); ?></b><br /><br /><?php echo $invoicepdf->tc; ?>
            </div>
            <?php } ?>
            <div class="col-md-12">
               <hr />
            ...
            <?php 
               if(!empty($invoicepdf) && $invoicepdf->use_as_default == 1) {
                 ...
                 <div class="col-md-3">
                   <?php echo nl2br($invoicepdf->contact_details); ?>
                   <br>
                   <b>Authorized Signature ___________</b>
                   <br><br>
                   <img src="<?php echo base_url($invoicepdf->signature); ?>">
                 </div>
               <?php  
               }
               ?>
