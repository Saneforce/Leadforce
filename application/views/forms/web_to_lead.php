      ...
      <div class="<?php if($this->input->get('col')){echo $this->input->get('col');} else {echo 'col-md-12';} ?>">
        ...
        <?php } ?>
         ...
         <div class="text-left col-md-12 submit-btn-wrapper">
          <button class="btn btn-success" style="background-color:<?php echo ($form->btn_color)?$form->btn_color:''; ?>; color:<?php echo ($form->txt_color)?$form->txt_color:''; ?>;" id="form_submit" type="submit"><?php echo $form->submit_btn_name; ?></button>
          <button class="btn btn-default" onclick="this.form.reset();">Clear</button>
        </div>
      </div>
