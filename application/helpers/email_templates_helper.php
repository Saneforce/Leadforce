...
//pre($original_template);
        ...
        if ($CI->input->post('email_template_custom')) {
            ...
            if($CI->input->post('email_sub')) {
                $template->subject = $CI->input->post('email_sub');
            } else {
                $template->subject = $original_template->subject;
            }
            if($CI->input->post('tempid')) {
                $template->emailtemplateid = $CI->input->post('tempid');
            }
        }
        //pre($template);
    }
