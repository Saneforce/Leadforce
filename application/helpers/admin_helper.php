...
function has_permission($permission, $staffid = '', $can = '')
{
    $CI = &get_instance();
     /**
     * If feature is enable return true
     */
    if ($CI->roles_model->is_feature_enable($permission)) {
...
function render_admin_js_variables()
{
    ...
    $options = [
		...
		'mark_complete_mandatory_to_add_new_activity'                    => 1*get_option('mark_complete_mandatory_to_add_new_activity'),
