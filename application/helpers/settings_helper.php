...
function app_init_settings_tabs()
{
	...
	$CI->app_tabs->add_settings_tab('company_settings', [
        'name'     => _l('company_mail_settings'),
        'view'     => 'admin/settings/includes/company_settings',
        'position' => 75,
    ]);
	$CI->app_tabs->add_settings_tab('deal', [
        'name'     => _l('deal'),
        'view'     => 'admin/settings/includes/deal',
        'position' => 80,
    ]);
	$CI->app_tabs->add_settings_tab('email_local', [
        'name'     => _l('email_local'),
        'view'     => 'admin/settings/includes/email_local',
        'position' => 85,
    ]);

    $CI->app_tabs->add_settings_tab('enable_call', [
        'name'     => _l('call_settings'),
        'view'     => 'admin/call_settings/view',
        'position' => 86,
    ]);
    $CI->app_tabs->add_settings_tab('agent', [
        'name'     => _l('agent'),
        'view'     => 'admin/agent/list',
        'position' => 87,
    ]);
	 $CI->app_tabs->add_settings_tab('smtp_settings', [
        'name'     => _l('settings_smtp_settings_heading'),
        'view'     => 'admin/settings/includes/smtp_settings',
        'position' => 88,
    ]);
	/*$CI->app_tabs->add_settings_tab('mandatory_deal', [
        'name'     => _l('deal'),

        'view'     => 'admin/settings/includes/mandatory_deal',
        'position' => 88,
    ]);
	$CI->app_tabs->add_settings_tab('mandatory_activity', [
        'name'     => _l('activity'),
        'view'     => 'admin/settings/includes/mandatory_activity',
        'position' => 89,
    ]);*/
