...
hooks()->add_action('admin_init', 'app_init_product_profile_tabs');
...
function core_merge_fields($fields)
{
    ...
    $fields[] = 'merge_fields/activity_reminder_merge_fields';
    $fields[] = 'merge_fields/show_alert_merge_fields';
