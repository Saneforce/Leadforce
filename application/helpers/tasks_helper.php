...
function get_tasks_all_fields()
{
	$aColumns_temp = array(
		...
		'startdate'=>db_prefix() . 'tasks.startdate', 
		'dateadded'=>db_prefix() . 'tasks.dateadded', 
		'datemodified'=>db_prefix() . 'tasks.datemodified', 
		'datefinished'=>db_prefix() . 'tasks.datefinished', 
