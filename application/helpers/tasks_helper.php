...
function get_tasks_all_fields()
{
	$aColumns_temp = array(
		...
		'startdate'=>db_prefix() . 'tasks.startdate as startdate', 
		'dateadded'=>db_prefix() . 'tasks.dateadded as dateadded', 
		'datemodified'=>db_prefix() . 'tasks.datemodified as datemodified', 
		'datefinished'=>db_prefix() . 'tasks.datefinished as datefinished', 
