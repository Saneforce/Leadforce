...
/**
 * Find and set sub domain name
 */
$subdomain_arr = explode('.', $_SERVER['HTTP_HOST'], 2);
$subdomain_name = $subdomain_arr[0];
if (in_array($subdomain_name, array('localhost', APP_BASE_URL, 'perfex'))) {
$subdomain_name = '';
}
if(empty($subdomain_name)){
// $subdomain_name='default';
}
defined('SUB_DOMAIN_NAME') or define('SUB_DOMAIN_NAME',$subdomain_name);
