...
define('PRODUCT_ATTACHMENTS_FOLDER', FCPATH . 'uploads/products' . '/');
/**
...
define('DBT_BASETABLE', array('countries','currencies','emailtemplates','leads_email_integration','leads_sources','leads_status','migrations','options','payment_modes','roles','tickets_priorities','tickets_status','deallossreasons','designations','modules_permissions','projects_status','tasktype'));

define('DBT_DATATABLE', array('activity_log','announcements','clients','consents','consent_purposes','contacts','contact_permissions','contracts','contracts_types','contract_comments','contract_renewals','creditnotes','creditnote_refunds','credits','customers_groups','customer_admins','customer_groups','customfields','customfieldsvalues','departments','dismissed_announcements','estimates','events','expenses','expenses_categories','files','form_questions','form_question_box','form_question_box_description','form_results','gdpr_requests','invoicepaymentrecords','invoices','itemable','items','items_groups','item_tax','knowedge_base_article_feedback','knowledge_base','knowledge_base_groups','leads','lead_activity_log','lead_integration_emails','mail_queue','milestones','modules','newsfeed_comment_likes','newsfeed_posts','newsfeed_post_comments','newsfeed_post_likes','notes','notifications','pinned_projects','projectdiscussioncomments','projectdiscussions','projects','project_activity','project_files','project_members','project_notes','project_settings','proposals','proposal_comments','related_items','reminders','sales_activity','services','sessions','shared_customer_files','spam_filters','staff','staff_departments','staff_permissions','subscriptions','taggables','tags','tasks','taskstimers','tasks_checklist_templates','task_assigned','task_checklist_items','task_comments','task_followers','taxes','tickets','tickets_pipe_log','tickets_predefined_replies','ticket_attachments','ticket_replies','todos','tracked_mails','user_auto_login','user_meta','vault','views_tracking','web_to_lead','pipeline','project_contacts','conversion_rate','importfiles','products','product_category','product_files','product_notes','project_products','unit_price','variations','variation_price'));
