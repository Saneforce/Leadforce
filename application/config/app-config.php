...
*/
define('APP_ENC_KEY', '149fa168ac121f3d1dbd0bf89b1b4673');
 ...
 */
//define('APP_DB_NAME', 'crm_new1');
//define('APP_DB_NAME', 'crm_aci');
define('APP_DB_NAME', 'crm_5');
//define('APP_DB_NAME', 'trial_crm');
//define('APP_DB_NAME', 'dm_crm');
//define('APP_DB_NAME', 'crm_demo');
//define('APP_DB_NAME', 'crm_demo1');
//define('APP_DB_NAME', 'crm_trail');
